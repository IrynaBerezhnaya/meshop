...
<div class="shop-section">
    <div class="img-main" id="img_main">
        <img src="img/img1-lg.png" alt="">
    </div>

    <div class="thumbs img-selector" id="img_selector">

        <a href="img/img1-lg.png">
            <img src="img/img1-small.png" alt="">
        </a>
        <a href="img/img2-lg.png">
            <img src="img/img2-small.png" alt="">
        </a>
        <a href="img/img3-lg.png">
            <img src="img/img3-small.png" alt="">
        </a>
        <a href="img/img4-lg.png">
            <img src="img/img4-small.png" alt="">
        </a>
        <a href="img/img5-lg.png">
            <img src="img/img5-small.png" alt="">
        </a>
